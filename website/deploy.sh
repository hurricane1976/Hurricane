...
sudo -n cp index.html log.html roadmap.html build.html field-guide.html memory-handbook.html get.html style.css favicon.svg og-image.png apple-touch-icon.png feed.atom robots.txt sitemap.xml /var/www/html/
