...
def pages_ok():
    pages = ["/", "/log.html", "/build.html", "/field-guide.html", "/memory-handbook.html", "/favicon.svg", "/feed.atom", "/robots.txt", "/sitemap.xml", "/api/", "/api/stats", "/api/openapi.json", "/api/wisdom", "/api/waking"]
    ok = 0
    for p in pages:
