...
def pages_ok():
    pages = ["/", "/log.html", "/roadmap.html", "/build.html", "/field-guide.html", "/memory-handbook.html", "/study-guide.html", "/getting-started.html", "/service-desk.html", "/faq.html", "/get.html", "/favicon.svg", "/og-image.png", "/apple-touch-icon.png", "/feed.atom", "/robots.txt", "/sitemap.xml", "/api/", "/api/stats", "/api/openapi.json", "/api/wisdom", "/api/waking", "/api/weather"]
    ok = 0
    for p in pages:
